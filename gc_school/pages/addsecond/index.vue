	...
	<block>
		...
		<view class="weui-cells weui-cells_after-title page">
			<view class="beijing">
				...
				<view class="cu-form-group">
					...
					<input @input="bookNameInput" placeholder="请输入商品的名称" />
				</view>
				<view class="cu-form-group margin-bottom">
					<!-- <view class="title">具体描述</view> -->

					<textarea :autoHeight="true" @input="descInput" maxlength="-1" placeholder="在此输入商品描述"></textarea>
			...
			<view class="beijing">
				...
				<view class="cu-form-group">
					...
					<input @input="oldpriceInput" v-model="oldprice" style="text-align: right;" name="oldPrice" placeholder="最多保留两位小数"
						type="digit" />
				</view>
				<view class="cu-form-group">
					<view class="title">现价</view>
					<input @input="newpriceInput" v-model="newprice" style="text-align: right;" name="newPrice" placeholder="最多保留两位小数"
						type="digit" />
				</view>
				<view class="cu-form-group">
					<view class="title">库存</view>
					<input @input="stockFun" style="text-align: right;" name="stock" placeholder="请输入库存"
						type="number" />
				</view>
			</view>
			<view class="beijing">
				...
				<view class="cu-form-group">
					...
					<input @input="phoneFun" style="text-align: right;" name="phone" placeholder="请输入电话"
						type="number" />
				</view>
			</view>
        ...
        <view class="image_content">
            <view class="image" wx:for="{{img_url}}" wx:key="index">
                <image bindtap="previewImg" class="moment_img" data-index="{{index}}" mode="aspectFill" src="{{item}}"></image>
            </view>
	...
	export default {
		...
		methods: {
			...
			save() {
				...
				if (self.name == '' || self.oldprice == '' || self.newprice == '' || self.desc == '' || self.phone == '') {
					app.globalData.util.message('不能有空值', '', 'error');
					return false;
				}

				console.log("库存", self.stock);
